...
/**
 * Test of Eppstein.Eppstein's algorithm for computing the K shortest paths between two nodes in a graph.
 *
...
public class TestEppstein {
    ...
    public static void usageExample1(String graphFilename, String source, String target, int k) {
        ...
        System.out.print("using Eppstein.Eppstein's algorithm... ");
        List<Path> ksp;
