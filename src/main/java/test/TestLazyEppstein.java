...
import algorithms.eppstein.LazyEppstein;
import tools.Graph;
import util.Path;
...
/**
 * Test of the lazy version of Eppstein.Eppstein's algorithm for computing the K shortest paths between two nodes in a graph.
 *
...
public class TestLazyEppstein {
    ...
    public static void main(String args[]) {
        ...
        /* Example 3 */
        graphFilename = "src/main/java/test/small_road_network_01.txt";
        sourceNode = "5524";
        targetNode = "7239";
        K = 1000;
    ...
    public static void usageExample1(String graphFilename, String source, String target, int k) {
        ...
        System.out.print("using the lazy version of Eppstein.Eppstein's algorithm... ");
        List<Path> ksp;
