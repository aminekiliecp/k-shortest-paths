...
/**
 * Lazy version of Eppstein.Eppstein's algorithm (by Jimenez and Marzal) for computing the K shortest paths
...
public final class LazyEppstein extends Eppstein implements KSPAlgorithm {
     ...
     * version of Eppstein.Eppstein's algorithm. ("A lazy version of Eppstein.Eppstein's K shortest paths algorithm", Jimenez & Marzal)
     *
     * See Eppstein.Eppstein.java for explanatory notes about Eppstein.Eppstein's algorithm.
     *
     * Some explanatory notes about how lazy Eppstein.Eppstein's algorithm works, given Eppstein.Eppstein's algorithm:
     * - Main idea: Instead of building the entire Eppstein.Eppstein heap before finding any of the K shortest paths, build the
     ...
     * - Building H_T(v) requires H_T(nextT(v)) to be built (see Eppstein.Eppstein.java for more info), so this may initiate a
    ...
    public List<Path> ksp(Graph graph, String sourceLabel, String targetLabel, int K) {
        ...
        for (int i = 0; i < K && pathPQ.size() > 0; i++) {
            ...
            // Note: this is where all of the heap building happens in the lazy version of Eppstein.Eppstein's algorithm.
    ...
    private static void buildHeap(String nodeLabel, Graph graph, HashMap<String, Double> sidetrackEdgeCostMap, HashMap<String, EppsteinHeap> nodeHeaps, HashMap<String, EppsteinHeap> edgeHeaps, HashMap<String, EppsteinHeap> outrootHeaps, HashMap<String, EppsteinArrayHeap> arrayHeaps, ShortestPathTree tree) {
        ...
        // Index the static, pointer representation of H_T(v), which is traversed by Eppstein.Eppstein's algorithm to add
